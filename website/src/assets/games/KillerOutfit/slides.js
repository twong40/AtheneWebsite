const KOSlides = [
  {
    id: 0,
    leftText:
      "Killer Outfit: A fashion beat-em-up! In the metropolis of Neo Wrapture, " +
      "there's no stronger than the Fashionista Cabal on top. The Cabal holds " +
      "sway over the entire city, and if anyone dares to disagree, the Fashion " +
      "police will convince them otherwise. Play as Taylor, whose underground " +
